...
namespace Clipboards
{
    ...
    public partial class MainWindow : Window
    {
                                ...
                                else if (Clipboard.ContainsImage())
                                {
                                    ...
                                    using (System.IO.MemoryStream ms = new System.IO.MemoryStream())
                                    {
                                       ...
                                       if (saveImg)
                                        ...
                                        clip.Image =Imaging.CreateBitmapSourceFromHBitmap(ptr,IntPtr.Zero,Int32Rect.Empty,BitmapSizeOptions.FromEmptyOptions()) ;//path;
                                        map.Dispose();
                                    }
                                }
        ...
        {
            saveImg = (bool)saveImgBtn.IsChecked;
        }
        /// 
        /// 所有控件初始化完成后调用
        /// 
